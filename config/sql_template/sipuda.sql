...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 04 Jul 2019 pada 07.28
-- Versi server: 5.7.26
-- Versi PHP: 7.2.18
...
-- Database: `sipuda`
--
CREATE DATABASE IF NOT EXISTS `sipuda` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `sipuda`;
...
--
-- Pembuatan: 03 Jul 2019 pada 03.49
-- Pembaruan terakhir: 03 Jul 2019 pada 03.49
--
...
CREATE TABLE IF NOT EXISTS `anggota` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1570 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabel untuk anggota';
...
(0001, 11, 'Mike', 'Dalisay', 'admin@example.com', 'https://junglove.net/wp-content/uploads/2017/08/c7f1d4263ff000681dc9cc755fe943b4-600x600.jpg', '081246361064', 'Di bumi', '*3820DB1895C26747A592360B64556C6A70E99815', 'KTP', 6471012506980002, 'Balikpapan', '1998-06-25', 'Laki-Laki', 'Mahasiswa', 'Admin', '', 1, '2018-12-13 09:48:00', '2019-06-26 01:45:44'),
...
(0005, 15, 'Scott', 'Hanselman', 'user@example.com', 'https://i.imgur.com/ltva2En.jpg', '089617288809', 'Pulau Mocacchino', '*3820DB1895C26747A592360B64556C6A70E99815', 'Kartu Pelajar', 839402893, 'Balikpapan', '1998-05-19', 'Laki-Laki', 'Mahasiswa', 'Anggota', '', 1, '2018-12-13 09:48:00', '2019-06-26 01:46:23'),
...
--
-- Pembuatan: 03 Jul 2019 pada 03.49
-- Pembaruan terakhir: 04 Jul 2019 pada 03.38
--
...
CREATE TABLE IF NOT EXISTS `buku` (
  ...
  `tgl_perubahan` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `konten_digital` text,
  `idrelasibuku` int(75) DEFAULT NULL,
  PRIMARY KEY (`nomor_panggil`)
...
('AD-2810', 'Ubur-Ubur', 'Berenang Dengan Ubur Ubur', 'dika', '2019-02-06', 1, '12344563231', 'Bukune', '2019-07-04 11:18:26', '2019-07-04 11:38:42', 'https://upload.wikimedia.org/wikipedia/id/8/8f/Ubur-ubur-Lembur1.jpg', 1, 136, 'Fiksi', 'Monograf', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `peminjaman` (
  `id_peminjaman` int(7) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_buku` (`nomor_panggil_buku`)
) ENGINE=InnoDB AUTO_INCREMENT=4957078 DEFAULT CHARSET=latin7;
