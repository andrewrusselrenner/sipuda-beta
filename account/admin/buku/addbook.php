...
require($_SERVER['DOCUMENT_ROOT'].'/config/core.php');
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if($input)
        {
            ...
            echo "<h1 class='text-center'>Sukses. Buku telah ditambahkan dengan nomor panggil ".$bid."</h1>";
            echo "<h1 class='text-center'>Sukses. Buku telah ditambahkan dengan nomor panggil ".$bid."</h1>";
        ...
        else
        {
            ...
            echo "<h1 class='text-center'>Ada yang aneh".$bid."</h1>";
            echo stripslashes(json_encode($kon->error));
            //header("location:" . $_SERVER['HTTP_REFERER']);
        }
    }
    else
    {
    echo "<script>alert('Galat, lain post')</script>";
    }
?>